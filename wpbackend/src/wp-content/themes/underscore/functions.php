...
if ( ! function_exists( 'underscore_setup' ) ) :
	...
	function underscore_setup() {
		...
		register_nav_menus(
			array(
				'menu-2' => esc_html__( 'Footer', 'underscore' ),
			)
		);
...
function underscore_scripts() {
	...
	if (!is_admin()) { 
		...
		//wp_register_style( 'underscore-tailwind', get_template_directory_uri() . '/tailwind.css' );
		// enqueue styles and scripts
		//wp_enqueue_style( 'underscore-tailwind' );
	}	
...
/**
 * Get posts and custom posts types.
 */
function api_get_posts($args = null ) {
